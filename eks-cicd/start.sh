...
docker build  -t $IMAGE_REPO_NAME:$BUILD --build-arg REACT_APP_COGNITO_USER_POOL_ID=$REACT_APP_COGNITO_USER_POOL_ID --build-arg REACT_APP_COGNITO_CLIENT_ID=$REACT_APP_COGNITO_CLIENT_ID --build-arg REACT_APP_SOCKET_URL=$REACT_APP_SOCKET_URL --build-arg REACT_APP_API_URL=$REACT_APP_API_URL --build-arg GH_TOKEN=$GH_TOKEN .
